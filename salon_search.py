...
st.title("サロンサーチ")
price_limit = st.slider("最低化っと価格の上限",min_value=2000,max_value=8500,step=200,value=6000)
...
if selected_salon:url = filtered_df[filtered_df['name_salon'] == selected_salon]['link_detail'].values[0]
